...
GEMINI_API_KEY = 'AIzaSyDk2fBum4uqY3FKAGQNPcE0qsS9VDhGTmg'
...
async def sot(ctx):
    ...
    async def button_callback(interaction):
        ...
        # Gửi nội dung cho Gemini để tạo câu hỏi trắc nghiệm
...
bot.run('MTMzNDgyMzc3MjMwOTQyMjA4MQ.G4ixtm.mYnKVz-WM9Ocbe4iWEg0JYKmqJa_0plz1q2Gxk')
